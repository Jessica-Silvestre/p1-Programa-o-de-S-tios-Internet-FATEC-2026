...
🚀 Projeto Front-End – Consumo de API com JavaScript. Este projeto foi desenvolvido como parte da disciplina de Programação de Sítios Internet - FATEC.
...
● Injeção final: O card pronto é "pendurado" na nossa galeria principal.